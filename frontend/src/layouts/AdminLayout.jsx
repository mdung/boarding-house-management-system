...
import {
  ...
  LogOut, Settings, BarChart3, ShoppingCart, Package, Menu, CalendarDays, BookOpen, ShieldCheck, History, XCircle, HardDriveDownload, ChevronDown, Palette, LayoutGrid, ClipboardList, Database, RefreshCw
} from 'lucide-react'
...
const menuGroups = [
  ...
  },
  {
    ...
    items: [
      ...
      { path: '/admin/sync-local', icon: RefreshCw, label: 'Sync from Local', adminOnly: true },
